...
- **Evidence:** `../04-design/test-design.md`, `../06-quality-security/ai-test-review.md`, `CONTRIBUTING.md` issue/acceptance-criteria workflow.
...
- **Improvement chain:**
  ...
  - **Template:** Reuse `../04-design/test-design.md` structure.
...
- **Evidence:** `../08-incident-learning/WO-401-evidence.md`, `../06-quality-security/pr-quality-gates.md`, `.github/workflows/ci.yml`.
...
- **Improvement chain:**
  ...
  - **Template:** Reuse the failure evidence structure in `../08-incident-learning/WO-401-evidence.md`.
...
- **Evidence:** `it-support-ticket-app/backend/src/test/resources/application.yml`, `TicketControllerIntegrationTest.java`, `../06-quality-security/pr-quality-gates.md`.
...
- **Evidence:** `../06-quality-security/ai-test-review.md`, `DemoDataInitializerTest.java`, `../04-design/test-design.md`.
...
- **Evidence:** `../06-quality-security/ai-human-review.md`, `CONTRIBUTING.md`, `.github/PULL_REQUEST_TEMPLATE.md`, `../08-incident-learning/WO-401-evidence.md`.
...
- **Improvement chain:**
  ...
  - **Template:** Reuse `../06-quality-security/ai-human-review.md` and the PR template.
...
- **Evidence:** `../06-quality-security/owasp-review.md`, `../06-quality-security/ai-human-review.md`, `../08-incident-learning/WO-401-evidence.md`.
...
- **Improvement chain:**
  ...
  - **Template:** Reuse the finding format in `../06-quality-security/owasp-review.md`.
...
- **Evidence:** `.github/PULL_REQUEST_TEMPLATE.md`, `CONTRIBUTING.md`, `../06-quality-security/pr-quality-gates.md`.
...
- **Improvement chain:**
  ...
  - **Template:** Reuse the existing PR template and `../08-incident-learning/WO-401-evidence.md` structure.
...
- **Evidence:** `.github/workflows/ci.yml`, root/backend POMs, `../06-quality-security/pr-quality-gates.md` Gap 1.
...
- **Evidence:** `../08-incident-learning/WO-401-evidence.md`, `../04-design/test-design.md`, `../06-quality-security/ai-test-review.md`, `../06-quality-security/owasp-review.md`.
...
- **Evidence:** `.github/workflows/ci.yml`, `../06-quality-security/pr-quality-gates.md` Gap 2, `../08-incident-learning/WO-401-evidence.md`.
...
- **Improvement chain:**
  ...
  - **Template:** Reuse the Merge Gate and Evidence sections in `../06-quality-security/pr-quality-gates.md`.
...
| --- | --- | --- | --- |
| CI-001 | Human review/documentation | `../04-design/test-design.md` | Existing, human-enforced |
| CI-002 | Work Order evidence | `../08-incident-learning/WO-401-evidence.md` | Proven by WO-401 |
| CI-003 | Test configuration | Test `application.yml` | Existing, configuration-enforced |
| CI-004 | Test review | `../06-quality-security/ai-test-review.md` | Existing, human-enforced |
| CI-005 | PR/human review | `../06-quality-security/ai-human-review.md`, PR template | Existing, human-enforced |
| CI-006 | Security review document | `../06-quality-security/owasp-review.md` | Existing, human-enforced |
| CI-007 | PR template and CI | `.github/PULL_REQUEST_TEMPLATE.md` | Existing, partially automated |
| CI-008 | No current wrapper/toolchain pin | `../06-quality-security/pr-quality-gates.md` | Recommended, not implemented |
